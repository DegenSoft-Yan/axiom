        ...
        <>
            <header id="header" className="header">
                ...
                <div className="wrapper_">
                    <div className={isMenuOpen ? ' header-nav-bar header-nav-active' : 'header-nav-bar'} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                        <div className="fixed">
                            <div className="header-nav">
                            <a href="/" style={{ cursor: 'pointer' }}>
        <img src={axiomlogo} alt="Главная страница" />
    </a>                                <img className="burger" src={burger} onClick={toggleMenu} alt="" />
                                <nav >
                                    ...
                                    {(isOpen) && (
                                        <div className="drop-down-content" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                                            <a href="https://axiom-wm.com/" target="_blank" rel="noopener">
                                                Family Office
                                            </a>
                                            <a href="http://datacenter.axiom-wm.com/" target="_blank" rel="noopener">
                                                Data Center
                                            </a>
                                            <a href="https://crypto.axiom-wm.com/" target="_blank" rel="noopener">
                                                Crypto
                                            </a>
                                            <a href="https://axiom-wm.com/international-estate-asset-management" target="_blank" rel="noopener">
                                                Real Estate
                                            </a>
                                        </div>
                                    )}
                                    ...
                                    {address ? (
                                        <button className="button"><Link to="/dashboard">{address}</Link></button>
                                        ) : (
